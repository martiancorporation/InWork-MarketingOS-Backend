...
# Generous enough for a full pasted document (e.g. a meeting transcript), but
# stops multi-MB payloads that bloat the DB and blow up downstream LLM token cost.
MAX_TEXT = 100_000
