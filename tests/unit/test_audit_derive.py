...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "PATCH",
            f"/api/v1/clients/{CID}/onboarding",
            "clients",
            True,
            "clients.onboarding.update",
        ),
        (
            "POST",
            f"/api/v1/clients/{CID}/onboarding/complete",
            "clients",
            True,
            "clients.onboarding.complete.create",
        ),
        ("POST", f"/api/v1/clients/{CID}/documents", "clients", True, "clients.documents.create"),
        (
            "DELETE",
            f"/api/v1/clients/{CID}/assignments/{UID}",
            "clients",
            True,
            "clients.assignments.delete",
        ),
